        ...
        <div className="bg-gray-800/50 rounded-lg p-12 border border-cyan-500/20 mb-12">
          ...
          <div className="text-gray-300 text-lg leading-relaxed space-y-6">
            ...
            <p>
              ...
              Escaperoneros y que, desde el 9 de septiembre de 2023, ha ido creciendo junto a nosotros.
            </p>
            <p>
              Desde entonces hemos visitado decenas de escape rooms, aprendido a valorar cada detalle de 
              una experiencia y compartido nuestras opiniones con una idea muy clara: ayudar a otros jugadores 
              a descubrir salas que realmente merezcan la pena.
            </p>
            <p>
              Hoy damos un paso más con esta web. Queremos que Escaperoneros siga creciendo y se convierta 
              en un lugar donde cualquier amante de los escape rooms pueda encontrar recomendaciones sinceras, 
              reseñas sin spoilers, rankings, noticias y todo lo relacionado con este mundo que tanto nos apasiona.
            </p>
          </div>
        </div>
